    ...
    <Background>
      <View style={screenStyles.bottomform}>
        {socialButtons.map(({ id, label, image, style }) => (
          <TouchableOpacity key={id} style={[screenStyles.button, style]} onPress={id === 3 ? continueAsGuest : onLogin}>
        ...
        <TouchableOpacity style={[screenStyles.button, screenStyles.emailButton]} onPress={() => navigateToScreen('Email')}>
